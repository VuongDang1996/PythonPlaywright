...
def test_tc11_verify_subscription_in_cart_page(home_page):
    ...
    AllureHelpers.add_test_id("TC11")
    AllureHelpers.add_description("Verify newsletter subscription functionality from cart page")
    ...
    with allure.step("Verify subscription section is visible"):
        ...
        AllureHelpers.add_screenshot("Subscription Section in Cart", home_page.page.screenshot())
    ...
    with allure.step("Subscribe to newsletter"):
        ...
        AllureHelpers.add_parameter("Subscription Email", test_email)
    ...
    with allure.step("Verify subscription success"):
        ...
        AllureHelpers.add_screenshot(
            "Newsletter Subscription Success", home_page.page.screenshot()
        )
